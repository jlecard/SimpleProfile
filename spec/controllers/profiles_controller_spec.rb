...
describe ProfilesController do
  describe "Authenticated" do
    ...
    def valid_attributes
      Factory.build(:profile,:user=>Factory.build(:user)).attributes
    end
    ...
    describe "GET new" do
      it "should redirect and show a message" do
        set_http_referer
        get :new, {}, valid_session
        response.should redirect_to "http://test.host/profiles?locale=fr"
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested profile" do
          ...
          #Profile.any_instance.should_receive(:update_attributes).with({'city' => 'Melun'})
          put :update, {:id => @profile.to_param, :profile => {'city' => 'Melun','country'=>'France'}}, valid_session
        end

        it "assigns the requested profile as @profile" do
          sleep(1) # Prevent OVER_QUERY_LIMIT from google geocode API
          put :update, {:id => @profile.to_param, :profile => {'city' => 'Orly','country'=>'France'}}, valid_session
          assigns(:profile).should eq(@profile)
        end
        ...
        it "redirects to the profile" do
          ...
          put :update, {:id => @profile.to_param, :profile => {'city' => 'Marseille','country'=>'France'}}, valid_session
    ...
    describe "POST create" do
      describe "with valid params" do
        it "creates a new profile" do
          profile = Factory.build(:profile2,:user=>Factory.build(:user2))
          expect {
        ...
        it "assigns a newly created profile as @profile" do
          set_http_referer
          profile = Factory.build(:profile2)
          profile.user = Factory.build(:user2)
          post :create, {:profile => profile.attributes}
        ...
        it "redirects to the back page" do
          ...
          profile = Factory.build(:profile2,:user=>Factory.build(:user2))
          post :create, {:profile => profile.attributes}
          response.should redirect_to(assigns(:profile))
        end
      end
